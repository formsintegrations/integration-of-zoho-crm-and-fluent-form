...
namespace BitCode\BITFFZC\Integration;
...
final class Integrations
{
    ...
    public function save($data)
    {
        ...
        if (!is_null($missing_field)) {
            wp_send_json_error(sprintf(__('%s cann\'t be empty', 'bitffzc'), $missing_field));
        }
        ...
        wp_send_json_success(['id' => $saveStatus, 'msg' => __('Integration saved successfully', 'bitffzc')]);
    }
    ...
    public function update($data)
    {
        ...
        wp_send_json_success(__('Integration updated successfully', 'bitffzc'));
    }
    ...
    public function delete($data)
    {
        ...
        wp_send_json_success(__('Integration deleted successfully', 'bitffzc'));
    }
    ...
    public function toggle_status($data)
    {
        ...
        wp_send_json_success(__('Integration status changed successfully', 'bitffzc'));
    }
