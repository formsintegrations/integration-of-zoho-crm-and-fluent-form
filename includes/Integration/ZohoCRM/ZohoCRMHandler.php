...
final class ZohoCRMHandler
{
    ...
    {
        \add_action('wp_ajax_bitffzc_zcrm_generate_token', array(__CLASS__, 'generateTokens'));
        \add_action('wp_ajax_bitffzc_zcrm_refresh_modules', array(__CLASS__, 'refreshModulesAjaxHelper'));
        \add_action('wp_ajax_bitffzc_zcrm_refresh_layouts', array(__CLASS__, 'refreshLayoutsAjaxHelper'));
    }
    ...
    public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues)
    {
        ...
        if (
            ...
            $error = new WP_Error('REQ_FIELD_EMPTY', __('module, layout, fields are required for zoho crm api', 'bitffzc'));
        ...
        if (
            ...
            $zcrmApiResponse = apply_filters('bitffzc_addRelatedList', $zcrmApiResponse, $this->_formID, $entryID, $this->_integrationID, $logID, $fieldValues, $integrationDetails, $recordApiHelper);
        }
        return $zcrmApiResponse;
    }
}
