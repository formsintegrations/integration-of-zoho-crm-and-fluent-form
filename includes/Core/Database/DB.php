...
namespace BitCode\BITFFZC\Core\Database;
...
final class DB
{
    ...
    public static function migrate()
    {
        ...
        $table_schema = array(
            "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}bitffzc_zoho_crm_log_details` (
            ...
            "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}bitffzc_integration` (
            ...
            "CREATE TABLE IF NOT EXISTS `{$wpdb->prefix}bitffzc_gclid` (
                `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
                `form_id` bigint(20) unsigned DEFAULT NULL, /* form_id = 0 means all/app */
                `user_id` bigint(20) unsigned DEFAULT NULL,
                `user_ip` int(11) unsigned DEFAULT NULL,
