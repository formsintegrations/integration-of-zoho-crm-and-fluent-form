...
function Table(props) {
  ...
  const showBulkDupMdl = () => {
    ...
    confMdl.btnTxt = __('Duplicate', 'bitffzc')
    confMdl.btn2Txt = null
    confMdl.btnClass = 'blue'
    confMdl.body = `${__('Do You want Deplicate these', 'bitffzc')} ${selectedFlatRows.length} ${__('item', 'bitffzc')} ?`
    confMdl.show = true
    setconfMdl({ ...confMdl })
  }
  ...
  const showStModal = () => {
    ...
    confMdl.btnTxt = __('Disable', 'bitffzc')
    confMdl.btn2Txt = __('Enable', 'bitffzc')
    confMdl.body = `${__('Do you want to change these', 'bitffzc')} ${selectedFlatRows.length} ${__('status', 'bitffzc')} ?`
    confMdl.show = true
    setconfMdl({ ...confMdl })
  }
  ...
  const showDelModal = () => {
    ...
    confMdl.btn2Txt = null
    confMdl.btnClass = ''
    confMdl.body = `${__('Are you sure to delete these', 'bitffzc')} ${selectedFlatRows.length} ${__('items', 'bitffzc')} ?`
    confMdl.show = true
    setconfMdl({ ...confMdl })
  }
          ...
          {props.rowSeletable && selectedFlatRows.length > 0 && (
            <>
              ...
              <small className="btcd-pill">
                {selectedFlatRows.length} {__('Row Selected', 'bitffzc')}
              </small>
            </>
          )}
        </div>
      ...
      <div className="btcd-pagination">
        ...
        <div>
          ...
          <small>
            ...
            {__('Page', 'bitffzc')}{' '}
            <strong>
              {pageIndex + 1} {__('of', 'bitffzc')} {pageOptions.length} &nbsp;
            </strong>{' '}
          </small>
          {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
          <label>
