  ...
  return (
    <>
      ...
      {!isPro && (
        <div className="pos-rel">
          ...
          <button
            ...
            style={{ '--tooltip-txt': `'${__('Refresh CRM Related Lists', 'bitffzc')}'` }}
            type="button"
            disabled={isLoading}
          >
            &#x21BB;
      ...
      {crmConf.default?.layouts?.[crmConf?.relatedlists?.[tab - 1]?.module]?.[
        ...
        <>
          <div className="mt-4">
            <b className="wdt-100">{__('Field Map', 'bitffzc')}</b>
          </div>
          <div className="btcd-hr mt-1" />
          <div className="flx flx-around mt-2 mb-1">
            <div className="txt-dp">
              <b>{__('Form Fields', 'bitffzc')}</b>
            </div>
            <div className="txt-dp">
              <b>{__('Zoho Fields', 'bitffzc')}</b>
            </div>
          </div>
          ...
          {crmConf.default?.layouts[crmConf.relatedlists[tab - 1].module]?.[
            ...
            Object.keys(
              ...
              <>
                <div className="mt-4">
                  <b className="wdt-100">{__('File Upload Field Map', 'bitffzc')}</b>
                </div>
                <div className="btcd-hr mt-1" />
                <div className="flx flx-around mt-2 mb-1">
                  <div className="txt-dp">
          ...
          <div className="mt-4">
            <b className="wdt-100">{__('Actions', 'bitffzc')}</b>
          </div>
          <div className="btcd-hr mt-1" />
